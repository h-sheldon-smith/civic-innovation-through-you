...
def Resident_Idea_Submission_View(request):
    ...
    idea_form = resident_form.SubmitIdea()

    if request.method == 'POST':
        idea_form = resident_form.SubmitIdea(request.POST) # make an idea submission using the request.POST contents
    ...
    context = {'idea_form': idea_form} # a dictionary of values to add to the template
    ...
    return render(request, 'ideas/ideas_resident.html', context)
